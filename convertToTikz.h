...
auto convertToTikz(fmindex_collection::search_scheme::Search _s, std::vector<size_t> const& counts, bool displayAlphabet, double fontSize, bool zeroIndex) -> std::string {
    assert(isValid(_s));
